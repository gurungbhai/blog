...
class DispatcherPanel extends React.Component {
    ...
    render() {
        ...
        switch(this.state.listContent) {
            ...
            case 'dispatch-map':
                listContent = <div className="col-md-4">
                        < clicked={this.handleRequestShow.bind(this)} />
                    </div>;
                break;
                    ...
                    <div className="row">
                        ...
                        <div className="col-xs-12">
                            ...
                            <div className="form-group"> 
                                ...
                                <br /> 
                                <input type="radio" id="booking_typeq" name="booking_type" value="1" className="js-switch booking_type" data-color="#f59345" defaultChecked/>

                                 <label htmlFor="booking_type">Indivisual</label>
                                <br /> 
                                <input type="radio" id="booking_type" name="booking_type" value="2" className="js-switch booking_type" data-color="#f59345"  />
