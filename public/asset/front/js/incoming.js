                ...
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="incoming-img bg-img" id="user-image" style={{ backgroundImage: 'url('+ window.image_path+'/'+this.props.request.user.picture + ')' }}></div>
...
class TripDetails extends React.Component {
    ...
    render() {
        ...
        if(this.props.request.user.picture != null) {
            picture = window.image_path+'/'+this.props.request.user.picture;
        }
        return (
            <div className="row no-margin">
                <div className="col-md-6">
                    <div className="provider-info">
                        ...
                        <div className="ride_info">
                            <span data-s_latitude={this.props.request.s_latitude}  data-s_longitude={this.props.request.s_longitude} data-d_latitude={this.props.request.d_latitude} data-d_longitude={this.props.request.d_latitude} ></span>
                        </div>
                    </div>
                    <br />
